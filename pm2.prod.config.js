module.exports = {
  ...
  apps: [{
    ...
    env: { // all environment
      ...
      'APP_PORT': '3001',
      'WECHAT_QUEUE': 'wechat',
      'TOKEN_URL': 'http://10.0.0.4:4000/internal/user/wechat/accessToken',
      'WECHAT_TEMPLATE_ID': 'W0SD6fOrDlSc763b19cndjvA82naKNvGy9NAGLZrjSo',
  ...
  },
  {
    ...
    env: { // all environment
      ...
      'TOKEN_URL': 'http://10.0.0.4:4000/internal/venues/wechat/accessToken',
      'WECHAT_TEMPLATE_ID': '1',
      'SMS_FREE_SIGN_NAME_0': '悦夜NightPlus'
    },
    'instances': 'max', // 如果是fork, 不用配置
